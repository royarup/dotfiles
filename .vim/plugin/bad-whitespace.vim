...
command! -range=% Delbws call <SID>EraseBadWhitespace(<line1>,<line2>)
command! Shbws call <SID>ShowBadWhitespace(1)
command! Hibws call <SID>HideBadWhitespace(1)
command! Togbws call <SID>ToggleBadWhitespace()
